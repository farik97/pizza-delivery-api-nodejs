...
// const DOMAIN = 'https://app.mailgun.com/app/sending/domains/sandbox34e3b01f00fa44ba98948a5c18f36b1f.mailgun.org';
// const mg = mailgun({apiKey: '38c4a1dcbf2e638d275f28e2a0459a63-aa4b0867-2c3cebed', domain: DOMAIN});
                ...
                _data.read('carts', cartId, (err, cartData)=>{
                    if (!err && email == cartData.recipient) {
                        ...
                        helpers.sendOrderStripe(cartData, (err)=>{
                            if (!err) {
                                callback(200, {'accepted': 'order charged'})
                            } else {
                                callback(err)
                            }
                        })
                        ...
                        //                 const data = {
                        //                     from: 'Pizza Delivery <me@samples.mailgun.org>',
